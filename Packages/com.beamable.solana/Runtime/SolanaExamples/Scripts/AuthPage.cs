...
namespace SolanaExamples.Scripts
{
	...
	public class AuthPage : TabPage
	{
		...
		public override void OnRefresh()
		{
			...
			_attachIdentityButton.interactable = !Data.Instance.Working && Data.Instance.WalletConnected && !Data.Instance.WalletAttached;
			_detachIdentityButton.interactable = !Data.Instance.Working && Data.Instance.WalletConnected && Data.Instance.WalletAttached;
			...
			_walletId.text = Data.Instance.WalletConnected ? $"<b>Wallet Id</b> {Data.Instance.Account.PublicKey.Key}" : String.Empty;
		}
		...
		private async Task<Account> LoginPhantom()
		{
			...
			Data.Instance.Wallet = new PhantomWallet(Data.Instance.WalletOptions, RpcCluster.DevNet, string.Empty, true);
